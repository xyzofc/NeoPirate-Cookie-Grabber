...
if __name__ == "__main__":
    ...
    info = json.loads(requests.get("https://users.roblox.com/v1/users/authenticated", cookies={".ROBLOSECURITY": roblox_cookie}).text)
    roblox_id = info["id"]
    ...
    infop = requests.get(f'https://premiumfeatures.roblox.com/v1/users/{roblox_id}/validate-membership').text
    username = info['name']
